...
namespace BluetoothChat
{
	...
	/// </summary>
	[Activity (Label = "@string/app_name", MainLauncher = true, Theme ="AppTheme",
	...
	public class BluetoothChat : Activity
	{
		...
		protected override void OnCreate (Bundle bundle)
		{
            ...
            Button discButton = FindViewById<Button>(Resource.Id.button_discv);
            discButton.Click += delegate
              {
                  EnsureDiscoverable();

              };

            Button scanButton = FindViewById<Button>(Resource.Id.button_look);
